...
public class APICoffeeTest {
    ...
    public void setup () {
        ...
        ivt.updateInventory( "Coffee", 15 );
        ivt.updateInventory( "Milk", 15 );
        ivt.updateInventory( "Sugar", 15 );
        ivt.updateInventory( "Chocolate", 15 );
        ...
        final Ingredient chocolateIngr = new Ingredient( "Chocolate", 0 );
