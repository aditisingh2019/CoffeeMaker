...
public class APIOrderTest {
    ...
    public void testGetOrdersManyOrders () throws Exception {
        ...
        final Order order1 = new Order( recipeList, 10, 5 );
    ...
    public void testGetOrder1Order () throws Exception {
        ...
        final Long id1 = order1.getId();

        final String orders = mvc.perform( get( "/api/v1/orders/" + id1 ) ).andDo( print() )
    ...
    public void testGetOrderManyOrders () throws Exception {
        ...
        final String order1String = mvc.perform( get( "/api/v1/orders/" + id1 ) ).andDo( print() )
                .andExpect( status().isOk() ).andReturn().getResponse().getContentAsString();
        ...
        final Long id2 = order2.getId();
        final Long id3 = order3.getId();

        final String order2String = mvc.perform( get( "/api/v1/orders/" + id2 ) ).andDo( print() )
                .andExpect( status().isOk() ).andReturn().getResponse().getContentAsString();

        assertTrue( order2String.contains( "Chai" ) );

        final String order3String = mvc.perform( get( "/api/v1/orders/" + id3 ) ).andDo( print() )
                .andExpect( status().isOk() ).andReturn().getResponse().getContentAsString();
    ...
    public void testCreateOrder1Recipe () throws Exception {
        ...
        final String orderString = mvc.perform( get( "/api/v1/orders/" + id3 ) ).andDo( print() )
                .andExpect( status().isOk() ).andReturn().getResponse().getContentAsString();
