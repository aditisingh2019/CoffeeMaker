...
public class APIUserTest {
	...
	public void testGetUser() throws Exception {
		...
		mvc.perform(
				post("/api/v1/users/").contentType(MediaType.APPLICATION_JSON).content(TestUtils.asJsonString(user1)));
		...
		mvc.perform(
				post("/api/v1/users/").contentType(MediaType.APPLICATION_JSON).content(TestUtils.asJsonString(user2)));
		userservice.save(user2);

		mvc.perform(
				post("/api/v1/users/").contentType(MediaType.APPLICATION_JSON).content(TestUtils.asJsonString(user3)));
