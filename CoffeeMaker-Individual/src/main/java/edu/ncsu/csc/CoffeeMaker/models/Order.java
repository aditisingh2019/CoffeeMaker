...
public class Order extends DomainObject {
	...
	@JoinTable(name = "order_recipes", joinColumns = @JoinColumn(name = "order_id"), inverseJoinColumns = @JoinColumn(name = "recipes_id"))
	 ...
	 *
	 * @param recipes the list of recipes in the order
	 ...
	 */
	public Order(final List<Recipe> recipes, final Integer payment, final Integer price) {
		setStatus("Placed");
		this.recipes = recipes;
		setPrice();
		setPayment(payment);
	 ...
	 * @param quantity the number of instances of the recipe to add
	 */
	...
	public String toString() {
		String s = "";
		s += ("Order [id=" + id + ", " + "payment " + " =" + payment + ", price=" + price + ", status=" + status + "]");

		for (final Recipe r : this.getRecipes()) {
			s += " " + r.getName();
		}
