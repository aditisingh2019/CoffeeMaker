...
public class Order extends DomainObject {
    ...
    //
    // return "Order [id=" + id + ", recipes=" + recipes + ", payment=" +
    // payment + ", price=" + price + ", status="
    // + status + "]";
    //
    // }
    //
    ...
    // return Objects.equals( id, other.id ) && Objects.equals( payment,
    // other.payment )
    // && Objects.equals( price, other.price ) && Objects.equals( recipes,
    // other.recipes )
