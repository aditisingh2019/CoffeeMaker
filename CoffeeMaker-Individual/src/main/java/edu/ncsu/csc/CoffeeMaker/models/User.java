...
public class User extends DomainObject {
	 ...
	 * @param password the password of the password to authenticate
	 ...
	 *
	 * @param newPassword the new password to set this user to
	 */
	 ...
	 *
	 * @param userName    the new username to update the user's profile
	 * @param newPassword the new password to update the user's profile
	 */
